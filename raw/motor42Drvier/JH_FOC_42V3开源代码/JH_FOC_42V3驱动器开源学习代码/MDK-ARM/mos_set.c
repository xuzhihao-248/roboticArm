...
void HN1_set(uint16_t pulse)//操作开启高端pmos1
{
	__HAL_TIM_SetCompare(&htim2 ,TIM_CHANNEL_3,pulse );
}

void HN2_set(uint16_t pulse)//操作开启
{
 	__HAL_TIM_SetCompare(&htim2 ,TIM_CHANNEL_4,pulse );
}

void HN3_set(uint16_t pulse)//操作开启
{
	__HAL_TIM_SetCompare(&htim2 ,TIM_CHANNEL_1,pulse );
}

void HN4_set(uint16_t pulse)//操作开启
{
